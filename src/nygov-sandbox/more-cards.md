            ...
            <div class="t_cardsWrap">
                        ...
                        <div class="o-cardContent">
                            <div class="m-card__data">
                                ...
                                <div class="a-text__html a-card__description">
                                    <p>This is where the description goes for the article page. This will appear on the card. his is where the description goes for the article page. This will appear on the card.</p>
                                </div>
                            </div>
                        </div>
                    </article>
                ...
                <div class="t_cardContainerRight">
                    ...
                    <article class="o-cardGlobalTablet">
                        ...
                        <div class="o-cardContent">
                            <div class="m-card__data">
                                <div class="m-cardTabletWrap">
                                    <!-- wrap the inner card details -->
                                    <div class="m-cardSectionDescription">
                                        <!-- event description -->
                                        <h3>
